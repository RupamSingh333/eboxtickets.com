...
var WeekHeadColor = "#1e8ad2!important"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var FontColor = "#FFFFFF!important"; //color of font in Calendar day cell.
var TodayColor = "#1e8ad2!important;color:#FFFFFF!important"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#008000!important;color:#FFFFFF!important"; //var SelDateColor = "#1e8ad2!important";//Backgrond color of selected date in textbox.
...
function RenderCssCal(bNewCal) {
    ...
    if (Cal.ShowTime === true) {
        ...
        vCalTime += "<td width='30px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:30px\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
        vCalTime += "</td><td style='font-weight:bold;text-align:center;'>:</td><td width='30px'>";
        vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 30px\" value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";

        if (Cal.ShowSeconds) {
            vCalTime += "</td><td style='font-weight:bold;'>:</td><td width='30px'>";
            vCalTime += "<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 30px\" value=" + Cal.Seconds + " onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
        }
        ...
        vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input class='btn btn-info mt-2' style='width:60px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\">&nbsp;&nbsp;&nbsp;&nbsp;<input class='btn btn-info mt-2' style='width:60px;font-size:12px;background-color:#008000!important;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\"></td></tr>";
...
function selectDate(element, date) {
    ...
    element.style.background = '#000!important';
